...
namespace v2rayN
{
    class Utils
    {
        ...
        public static string GetSSHFilesPath(string filename)
        {
            string _tempPath = Path.Combine(StartupPath(), "sshFiles");
            if (!Directory.Exists(_tempPath))
            {
                Directory.CreateDirectory(_tempPath);
            }
        ...
        public static string getOpenSSLPath(string filename)
        {
            string _tempPath = Path.Combine(StartupPath(), "OpenSSL");
            if (!Directory.Exists(_tempPath))
            {
                Directory.CreateDirectory(_tempPath);
            }
